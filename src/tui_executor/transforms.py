...
command_log_file_location = os.environ.get("TUI_EXECUTOR_CMD_LOG_FILE_LOCATION", None)
...
def load_ipython_extension(ipython):
    ...
    print(f"Loading IPython extension 'tui_executor.transforms'... command log file={command_log_file_fd.name}")
    ipython.events.register('pre_run_cell', input_processor)
    ipython.events.register('post_run_cell', result_processor)


def unload_ipython_extension(ipython):
    print("Unloading IPython extension 'tui_executor.transforms'...")
